...
const LoginBox = props => (
  <div className="inside-box">
    ...
    <div className="buttons-box">
      ...
      />
      <Button type="submit" text="Войти" handler={props.handleLogin} />
    </div>
  </div>
);
...
const ForgotBox = props => (
  <div className="inside-box">
    ...
    />
    <div className="buttons-box">
      <Button type="button" text="Назад" handler={props.handleForgot} />
      <Button
        type="submit"
  ...
  render() {
    return (
      <div className="background">
        <div className="box">
          <Logo logoDiv="logoDiv" logo={logo} />
          ...
          {this.state.connectionStatus === 500 && ( // can be replaced with Error component
            <Text text={this.state.text} class="error-subtitle" />
          )}
        </div>
      </div>
    );
